const CACHE='entertainment-api-docs-v2-1';
const ROOT=new URL('./',self.location.href);
const assets=[
  './','./index.html','./manifest.webmanifest',
  './pages/quick-start.html','./pages/purchase-flow.html','./pages/api-reference.html','./pages/playground.html','./pages/error-assistant.html','./pages/test-coverage.html','./pages/governance.html','./pages/known-limitations.html','./pages/open-questions.html',
  ...
  './src/presentation/pages/home-page.js','./src/presentation/pages/quick-start-page.js','./src/presentation/pages/purchase-flow-page.js','./src/presentation/pages/api-reference-page.js','./src/presentation/pages/playground-page.js','./src/presentation/pages/error-assistant-page.js','./src/presentation/pages/test-coverage-page.js','./src/presentation/pages/governance-page.js','./src/presentation/pages/known-limitations-page.js','./src/presentation/pages/open-questions-page.js'
