...
{
    [Fact]
    public void Existing_lower_and_peer_packages_do_not_depend_back_on_caching()
    {
        var assemblies = new[]
        {
    ...
    [Fact]
    public void Caching_is_provider_neutral_and_has_no_framework_or_product_dependency()
    {
        AssertNoReferences(
